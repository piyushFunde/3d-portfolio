            ...
            <div className="flex w-full flex-col gap-6">
              <div>
                <BlurIn delay={0.4}>
                  <p
                    className={cn(
                      "md:self-start font-medium text-md text-slate-500 dark:text-zinc-400",
                ...
                <BlurIn delay={1}>
                  <p className="mt-4 text-left text-lg font-medium text-slate-500 dark:text-zinc-400 sm:text-xl">
